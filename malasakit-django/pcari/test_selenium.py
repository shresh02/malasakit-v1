...
#     @AbstractSeleniumTestCase.dump_driver_log_on_error
#     def test_personal_info_change(self):
#         self.flow()
#         expected_info = self.inputs['personal-info']

#         for code in self.languages:
#             self.driver.get("%s/%s/personal-information/" % (self.live_server_url, code))
#             self.driver.get_screenshot_as_file("personal-info-%s" % code)

#             self.assertEqual(expected_info['age'],
#                              int(self.driver.find_element_by_id('age').get_attribute('value')))
#             self.assertEqual(expected_info['province'],
#                              self.driver.find_element_by_id('province').get_attribute('value'))
#             self.assertEqual(expected_info['city'],
#                 self.driver.find_element_by_id('city-or-municipality').get_attribute('value'))
#             self.assertEqual(expected_info['barangay'],
#                 self.driver.find_element_by_id('barangay').get_attribute('value'))
